...
class Product(Base):
    ...
    service_invoice_validity_hours = Column(String, nullable=True)
    ...
    service_delivery_mode_data = Column(JSONText)
    service_required_details_data = Column(JSONText)
