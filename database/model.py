...
from models.deposits import Deposit, create_deposit, update_deposit, delete_deposit, force_delete_deposit, get_single_deposit_by_id, get_just_single_deposit_by_id, get_deposits, get_deposits_by_status, sum_of_deposits, count_of_deposits
...
from models.loan_applications import LoanApplication, create_loan_application, update_loan_application, delete_loan_application, force_delete_loan_application, get_single_loan_application_by_id, get_just_single_loan_application_by_id, get_loan_applications, count_loan_applications
from models.loans import Loan, create_loan, update_loan, delete_loan, force_delete_loan, get_single_loan_by_id, get_just_single_loan_by_id, get_just_single_loan_by_application_id, get_loans, sum_of_loans, count_loans, count_loans_with_pending_collections
