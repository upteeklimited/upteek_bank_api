...
from models.collections import Collection, create_collection, update_collection, delete_collection, force_delete_collection, get_single_collection_by_id, get_collections_by_loan_id, get_collections, sum_of_overdue_collections
...
from models.loans import Loan, create_loan, update_loan, delete_loan, force_delete_loan, get_single_loan_by_id, get_just_single_loan_by_id, get_loans, sum_of_loans, count_loans, count_loans_with_pending_collections
